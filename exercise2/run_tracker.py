...
from ms_tracker import MSParams, MSTracker

# from ms_tracker import MeanShiftTracker, MSParams


# set the path to directory where you have the sequences
dataset_path = "C:\\Users\\Nace\\Documents\\MAG2\\NMRV\\exercise2\\data\\vot2013"  # TODO: set to the dataet path on your disk
